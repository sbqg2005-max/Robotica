...
scara = rtb.DHRobot(
[
    rtb.RevoluteDH(d=0.254, a=0, alpha=np.deg2rad(-90),     qlim=[-0.240, 0.240]),
    rtb.RevoluteDH(d=0, a=0.410,   alpha=0, offset=np.deg2rad(-90), qlim=[-0.148, 0.148]),
    rtb.RevoluteDH(d=0,     a=0, alpha=np.deg2rad(-90),     qlim=[-0.150, 0.150]),
    rtb.RevoluteDH(d=0.625,     a=0,   alpha=np.deg2rad(90),     qlim=[-0.200, 0.200]),
    rtb.RevoluteDH(d=0,     a=0,     alpha=np.deg2rad(-90),     qlim=[-0.120, 0.120]),
], name="RV-5AS-D", base=SE3(0, 0, 0))
print(scara)
